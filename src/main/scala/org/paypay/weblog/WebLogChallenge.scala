...
object WebLogChallenge {
  ...
  */
  ...
  def main(arg: Array[String]): Unit = {
    ...
    val csvSchema = CommonUtils.getSchema
    ...
    CommonUtils.saveToDisk(weblog_sessionIds,outputPath+"sessionIds")
    ...
    */
    ...
    CommonUtils.saveToDisk(grouped_sessions.agg(avg("per_session_time")),outputPath+"avgSessionTime")
    ...
    CommonUtils.saveToDisk(average_sessions,outputPath+"mostEngagedUsers")
    ...
    CommonUtils.saveToDisk(weblog_uniqueCount_per_user_session.agg(avg("count_per_user_session")),outputPath+"uniqueCounts")
